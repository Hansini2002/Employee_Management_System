      ...
      <div className="row flex-nowrap">
        <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-white border-end">
          <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-dark min-vh-100">
            ...
            >
              <span className="fs-5 fw-bolder d-none d-sm-inline name">
                EMS
              </span>
            </Link>
            <ul
            ...
            >
              ...
              <li className="w-100">
                ...
                >
                  ...
                  <span className="ms-2 d-none d-sm-inline">Positions</span>
                </Link>
              </li>
              <li className="w-100">
                <Link
        ...
        <div className="col p-0 m-0">
          <div className="p-2 d-flex justify-content-center purple-container">
